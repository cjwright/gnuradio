...
class low_pass_filter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frequency_win = RangeWidget(self._frequency_range, self.set_frequency, "'frequency'", "slider", float, QtCore.Qt.Horizontal)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, (self.samp_rate/4), (self.samp_rate/4), window.WIN_HAMMING, 6.76))
